...
const Videos = () => {
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-0 h-[440px] w-[440px] rounded-full bg-[#FCB33A]/10 blur-[120px]" />

      <div className="relative z-10 mx-auto grid max-w-7xl px-4 gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
        <div>
          <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#FCB33A]/20 bg-[#FCB33A]/10 px-4 py-2 text-xs font-semibold uppercase tracking-[2px] text-[#FCB33A]">
            <Film size={14} />
            Video Tour
          </span>
          ...
          <h2 className="section-title">
            ...
            <span className="text-[#FCB33A]">Videos</span>
          </h2>
            ...
            {tabs.map((tab, index) => (
              <button
                ...
                className={`group w-full rounded-3xl border p-5 text-left transition-all duration-300 ${
                  activeTab === index
                    ? "border-[#FCB33A]/35 bg-[#FCB33A]/10 shadow-[0_18px_60px_rgba(252,179,58,0.12)]"
                    : "border-zinc-100 bg-white shadow-sm hover:border-[#FCB33A]/30"
                }`}
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl transition ${
                      activeTab === index
                        ...
                        : "bg-zinc-100 text-zinc-800 group-hover:bg-[#FCB33A] group-hover:text-black"
                    }`}
                  >
                  ...
                  <ArrowRight className="ml-auto mt-1 h-5 w-5 shrink-0 text-zinc-400 transition group-hover:text-[#FCB33A]" />
                </div>
              </button>
            ))}
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-[36px] border border-zinc-100 bg-white p-3 shadow-[0_30px_100px_rgba(0,0,0,0.15)]">
            ...
            <div className="p-5 text-center">
              <p className="text-xs font-semibold uppercase tracking-[2px] text-[#FCB33A]">
                Now Playing
              </p>
