        ...
        <div className="mb-10 grid gap-6 md:grid-cols-[0.9fr_1.1fr] md:items-end">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-bold tracking-tight text-white md:text-4xl">
              Elite Nearby{" "}
              <span className="text-[var(--accent)]">Essentials</span>
            </h2>
          </div>
          ...
          <div className="relative h-[380px] overflow-hidden rounded-[28px] md:h-[560px]">
            ...
            <div className="absolute bottom-5 left-5 right-5 rounded-3xl border border-white/10 bg-black/45 p-5 text-center backdrop-blur-xl md:text-left">
              <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                ...
                <div className="inline-flex items-center gap-2 rounded-full bg-[var(--accent)] px-5 py-3 text-sm font-bold text-white">
                  <MapPin size={17} />
        ...
        <div className="mt-6 grid gap-4 grid-cols-2 lg:grid-cols-4">
          {essentials.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="group rounded-[28px] border border-white/10 bg-white/[0.04] p-5 text-center backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent)]/40 hover:bg-[var(--accent)]/10"
              >
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 text-[var(--accent)] transition-all duration-300 group-hover:bg-[var(--accent)] group-hover:text-black">
                ...
                <p className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-xs font-semibold uppercase tracking-[1.5px] text-[var(--accent)]">
                  <Clock size={13} />
                  {item.dist}
                </p>
              </div>
