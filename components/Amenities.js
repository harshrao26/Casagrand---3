    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <span className="mb-4 inline-flex rounded-full border border-[var(--accent)]/20 bg-[var(--accent)]/10 px-4 py-2 text-xs font-semibold uppercase tracking-[2px] text-[var(--accent)]">
            100+ Lifestyle Amenities
          </span>

          <h2 className="section-title secti on-header-center">
            Elite Living <span className="text-[var(--accent)]">Amenities</span>
          </h2>
                ...
                <div className="grid grid-cols-3 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {page.map((item, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="group flex min-h-[150px] flex-col items-center justify-center rounded-3xl   border-zinc-100 bg-white p-5 text-center  -[0_18px_60px_rgba(0,0,0,0.06)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent)]/30 hover:bg-[var(--accent)]/5 border-2"
                      >
                        <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--accent)]/10 text-[var(--accent)] transition-all duration-300 group-hover:scale-110 group-hover:bg-[var(--accent)] group-hover:text-white">
