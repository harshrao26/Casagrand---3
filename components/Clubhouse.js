...
const Clubhouse = () => {
  ...
  const features = [
    { icon: <Coffee size={20} />, text: "Coffee Shop & Entertainment Lounge" },
    { icon: <Users size={20} />, text: "Multipurpose Hall & Social Spaces" },
    { icon: <Trophy size={20} />, text: "Squash, Badminton & Indoor Sports" },
    { icon: <Sparkles size={20} />, text: "Yoga, Jacuzzi, Steam, Salon & Spa" },
  ];
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center content-grid">
          ...
          >
            ...
            <p className="section-copy section-copy-on-dark mb-8 max-w-2xl font-medium">
              Indulge in the finest clubhouse experience at Casagrand
              Casablanca, featuring a grand 42,000 sq.ft clubhouse and an
              exclusive 26,000 sq.ft sports clubhouse with plush interiors,
              indoor recreation, wellness zones, co-working spaces, kids zones,
