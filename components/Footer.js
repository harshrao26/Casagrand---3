        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-zinc-400 leading-relaxed">
              Casagrand Estancia brings you the finest luxury living in the heart of the city. Experience unparalleled comfort and world-class amenities designed for your lifestyle.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center hover:bg-amber-600 transition-colors">
